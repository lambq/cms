...
class Dig0auu2 extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'dig:0auu2 {action}';
     ...
     * @var string
     */
    protected $description = 'dig:0auu2 all|update';
    ...
    public function __construct()
    {
        ...
        $this->key          = '0auu_2'.date('Y-m-d', time());
        $this->expiredAt    = now()->addMinutes(1680);
        $this->yesterday    = '0auu_2'.date("Y-m-d",strtotime("-1 day"));
        $this->randNum      = 100;
        $this->totalNum     = 0;
        $dayNum             = Cache::get('dayNum2');
    ...
    public function handle()
    {
        ...
        $this->article('http://hh.0auu.com/api/v2/article');
    }
    ...
    function article($url)
    {
        if ($this->totalNum >= $this->randNum)
        {
            ...
            Cache::put('dayNum2', $this->dayNum, $this->expiredAt);
