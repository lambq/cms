<aside class="sidebar bar1">
    <section class="widget theme-widget wow fadeInUp">
        ...
        <ul>
            <?php $__currentLoopData = article_limit($column->id); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <li>
                    <div class="thumbnail">
...
</aside><?php /**PATH /www/wwwroot/www.3cc0.com/resources/views/web3/layouts/right.blade.php ENDPATH**/ ?>